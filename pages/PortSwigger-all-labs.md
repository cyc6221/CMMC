---
layout: page
title: PortSwigger All Labs
permalink: /PortSwigger-all-labs/
toc: false
---
...
<ul class="lab-table">
  ...
  <li class="lab-row">
    <span class="level level--practitioner">PRACTITIONER</span>
    <span>Exploiting origin server normalization for web cache deception</span>
    <span class="lab-status">Todo</span>
  </li>

  <li class="lab-row">
    <span class="level level--practitioner">PRACTITIONER</span>
    <span>Exploiting cache server normalization for web cache deception</span>
    <span class="lab-status">Todo</span>
  </li>

  <li class="lab-row">
    <span class="level level--expert">EXPERT</span>
    <span>Exploiting exact-match cache rules for web cache deception</span>
    <span class="lab-status">Todo</span>
  </li>
</ul>
