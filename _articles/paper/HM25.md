...
<ul>
  <li>第 2 節：介紹定義與背景知識。 </li>
  <li>第 3 節：說明針對**互動式**與**非互動式 Sigma 協定**之**uniform-query reductions**所設計的模擬器（emulator）。 </li>
  <li>第 4 節：引入數個 **hitting games**，並結合第 5 節所證明的其數值界限，以及第 3 節的結果，進一步對 **uniform-query reductions** 的品質給出上界。 </li>
  <li>第 5 節：證明第 4 節所提出的 **hitting games** 的上下界。 </li>
</ul>
</div>
