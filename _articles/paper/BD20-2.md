...
<div class="remark">
<b>Note</b>
使用文獻 <a class="cite" href="#bib-br06">BR06</a> 的 code-based game playing framework。
</div>
...
<div class="algorithm">
  <div class="algorithm-title">Game $G^{\mathrm{imp\text{-}pa}}_{\mathrm{ID}}$</div>

  <p><strong>Init:</strong></p>
  <ol>
    <li>
      <code>Set</code>
      $(vk, sk) \xleftarrow{\$} \mathrm{ID.Kg}$
    </li>
    <li>
      <code>Return</code>
      $vk$
  ...
  <ol>
    <li>
      <code>Set</code>
      $(b, tr) \xleftarrow{\$} \mathrm{Exec}_{\mathrm{ID}}(vk, sk)$
    </li>
    <li>
      <code>Return</code>
      $tr$
  ...
  <p><strong>Ch($R_\ast$):<code>// One query</code></strong></p>
  <ol>
    <li>
      <code>Set</code>
      $c_\ast \xleftarrow{\$} \mathrm{ID.Ch}$
    </li>
    <li>
      <code>Return</code>
      $c_\ast$
  ...
  <ol>
    <li>
      <code>Return</code>
      $\mathrm{ID.Vf}(vk, R_\ast, c_\ast, z_\ast)$
    </li>
  </ol>
</div>
...
- If $g \in \mathrm{G}^*$ is a generator and $X \in \mathrm{G}$,
  - then the discrete logarithm of $X$ with respect to the base $g$ is denoted by $\mathrm{DL}_{\mathrm{G},g}(X)$, and it belongs to the set $\mathbb{Z}_{\lvert G\rvert}$.
