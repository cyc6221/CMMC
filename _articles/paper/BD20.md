...
## A Okamoto Identification and Signature Scheme from MBDL

See [A Okamoto Identification and Signature Scheme from MBDL]({{ "/articles/paper/BD20-A/" | relative_url }}).

## B Ratio-based tightness

See [B Ratio-based tightness]({{ "/articles/paper/BD20-B/" | relative_url }}).
