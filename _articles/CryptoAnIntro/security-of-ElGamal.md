...
這個 proof 採用 **reduction to DDH** 的方式。假設存在一個 polynomial-time adversary $A$，可以破壞 ElGamal encryption 的 polynomial security，則我們將利用 $A$ 來構造一個演算法，進而解出 DDH problem，與 DDH assumption 矛盾。
